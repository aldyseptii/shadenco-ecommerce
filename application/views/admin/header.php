      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-footer">
            <a href="<?=base_url('admin/edit_profile');?>" class="btn btn-default btn-flat"><i class="fas fa-user-edit"></i> Edit Profile</a>
            <a href="<?=base_url('admin/auth/logout');?>" class="btn btn-default btn-flat float-right"><i class="fas fa-sign-out-alt"></i> Logout</a>
          </li>
        </ul>
      </li>
      ...
      <div class="sidebar">
          ...
          <li class="nav-item has-treeview">
            ...
            <?php if($admin_info['id_level'] < 2) { ?>
              ...
              <li class="nav-item">
                <a href="<?=base_url('admin/rajaongkir/origin');?>" class="nav-link">
                <i class="nav-icon far fa-circle"></i>
                  <p>Origin</p>
                </a>
              </li>
            <?php } ?>
              ...
              <li class="nav-item">
                <a href="<?=base_url('admin/rajaongkir/courier');?>" class="nav-link">
                <i class="nav-icon far fa-circle"></i>
                  <p>Jasa Ekspedisi</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?=base_url('admin/midtrans');?>" class="nav-link">
            <i class="nav-icon fas fa-copy"></i>
              <p>Midtrans API</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?=base_url('admin/shop_setting');?>" class="nav-link">
