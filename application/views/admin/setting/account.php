        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="https://sbncloth.co.id/admin/dashboard">Home</a></li>
...
$('.save-form').on('submit',function(){
    ...
    $.ajax({
        url: "<?=base_url();?>admin/edit_profile/save",
        method: "POST",
...
$('.upload-form').on('submit',function(){
    ...
    $.ajax({
        url: "<?=base_url();?>admin/edit_profile/save_photo",
        method: "POST",
        data: new FormData(this),
        contentType: false,
        cache: false,
