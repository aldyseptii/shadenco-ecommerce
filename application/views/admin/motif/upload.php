...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Upload Motif Warna</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body col-md-5 col-sm-12">
                            <form method="post" class="save-form" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-primary btn-save"><i class="fas fa-save"></i>
                                    Simpan</i></button>
                            </form>
                        </div>
                    </div>
...
<script>
    $('.save-form').on('submit', function () {
        ...
        $.ajax({
            url: "<?=base_url();?>admin/shop_setting/save",
            method: "POST",
