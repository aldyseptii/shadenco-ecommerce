...
<div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <a href="<?=base_url("admin/page/add");?>" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Tambah Halaman</a>
                        </div>
                        <hr/>
  ...
  <script>
    $('#tablePage').DataTable({
        ...
        "serverSide": true,
        "order": [],
        "ajax": {"url": "<?=base_url();?>admin/page/index_json"},
        "columnDefs": [
            { 
                "targets": [ 0 ], 
                "orderable": false, 
    ...
    $("body").on("click",".btn-del",function(){
        ...
        Swal.fire({
          ...
          if (result.value) {
            $.getJSON("<?=base_url();?>admin/page/delete/"+id,function(response){
              if(!response['status']) {
                Swal.fire(
                    'Gagal',
                    response['msg'],
