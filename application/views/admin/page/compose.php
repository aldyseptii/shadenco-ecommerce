        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?=base_url('admin/page');?>">Halaman</a></li>
...
<script>
  ...
  $('.btn-save').on('click',function(){
    ...
    $.ajax({
        url: "<?php if(!$edit) { echo base_url("admin/page/add_proccess"); } else { echo base_url("admin/page/edit_proccess/$page_value->id_page"); }?>",
        method: "POST",
