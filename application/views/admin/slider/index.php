...
<script>
    $('#tableSlider').DataTable({
        ...
        "serverSide": true,
        "order": [],
        "ajax": {"url": "<?=base_url();?>admin/slider/index_json"},
        "columnDefs": [
            { 
                "targets": [ 0 ], 
                "orderable": false, 
    ...
    $("body").on("click",".btnedit",function(){
        ...
        $.getJSON("<?=base_url('admin/slider/get');?>/"+id,function(result){
    ...
    $('.add-btn').on('click',function(){
        ...
        sendajax("<?=base_url('admin/slider/add');?>",".edit-form","add");
    });
    $('.edit-btn').on('click',function(){
        var id = $(this).attr("data-id");
        $(".progress-edit").toggle();
        $(".edit-btn").prop("disabled",true);
        sendajax("<?=base_url('admin/slider/edit');?>/"+id,".edit-formput","edit");
    });
    ...
    $("body").on("click",".btndelete",function(){
        ...
        Swal.fire({
          ...
          if (result.value) {
            $.getJSON("<?=base_url();?>admin/slider/delete/"+id,function(response){
              if(!response['status']) {
                Swal.fire(
                    'Gagal',
                    response['msg'],
